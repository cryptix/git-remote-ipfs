...
import (
	...
	ds "github.com/cryptix/git-remote-ipfs/Godeps/_workspace/src/github.com/jbenet/go-datastore"
	fs "github.com/cryptix/git-remote-ipfs/Godeps/_workspace/src/github.com/jbenet/go-datastore/fs"
	query "github.com/cryptix/git-remote-ipfs/Godeps/_workspace/src/github.com/jbenet/go-datastore/query"
)

func Test( // Hook up gocheck into the "go test" runner.
t *testing.T) { TestingT(t) }
